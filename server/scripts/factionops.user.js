...
`;
    ...
    function connectRealtime() {
        ...
        // --- Real-time Connection Strategy (v4.8.1) ---
        ...
        modal.innerHTML = `
            ...
            <div style="margin: 14px 0;">
                ...
                <div style="font-size:11px;opacity:0.6;margin-top:4px;">
                    ...
                    <span id="fo-enabled-roles-label">Enabled roles:</span> leader, co-leader, war leader, banker. <br>
